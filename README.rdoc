...
<code>com.example.User$Addressess$Address</code> results in the creation of 3 classes: <code>User</code>, <code>User::Addressess</code> 
and <code>User::Addressess::Address</code>, all within the <code>Com::Exampe</code> namespace.
